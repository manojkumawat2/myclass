...
/***
 * Initializing expand button
 *
 **/
 const expandTag = document.createElement('div');
 expandTag.classList.add('expandtag');
 const expandButton = document.createElement('button');
 expandButton.classList.add('myBtn');
 expandButton.innerHTML = "exapand";

 expandTag.appendChild(expandButton);
...
continueButt.addEventListener('click', () => {
    ...
    document.querySelector('#default_name').innerHTML = `${username} (You)`;
...
function handleVideoOffer(offer, sid, cname, micinf, vidinf) {
    ...
    connections[sid].ontrack = function (event) {
        ...
        if(!document.getElementById('attendie' + sid)) {
            ...
            name.innerHTML = `${cName[sid]}`;
            attendie.id = 'attendie' + sid;

            attendie.append(user_icon);
            attendie.append(name);

            document.querySelector(".attendies_details").append(attendie);
            document.querySelector(".attendies_details").append(document.createElement('hr'));
        }
